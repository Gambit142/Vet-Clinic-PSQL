...
INSERT INTO animals (name, date_of_birth, escape_attempt, neutered, WEIGHT_KG, species_id, owner_id) 
VALUES ('Agumon', '2020-02-03', 0, true, 10.23, 2, 1);
INSERT INTO animals (name, date_of_birth, escape_attempt, neutered, WEIGHT_KG, species_id, owner_id) 
VALUES ('Gabumon', '2018-11-15', 2, true, 8, 2, 2);
INSERT INTO animals (name, date_of_birth, escape_attempt, neutered, WEIGHT_KG, species_id, owner_id) 
VALUES ('Pikachu', '2021-01-07', 1, false, 15.04, 1, 2);
INSERT INTO animals (name, date_of_birth, escape_attempt, neutered, WEIGHT_KG, species_id, owner_id) 
VALUES ('Devimon', '2017-05-12', 5, true, 11, 2, 3);
INSERT INTO animals (name, date_of_birth, escape_attempt, neutered, WEIGHT_KG, species_id, owner_id) 
VALUES ('Charmander', '2020-02-08', 0, false, -11, 1, 4), ('Plantmon', '2022-11-15', 2, true, -5.7, 2, 3),
('Squirtle', '1993-04-02', 3, false, -12.13, 1, 4), ('Angemon', '2005-06-12', 1, true, -45, 2, 5),
